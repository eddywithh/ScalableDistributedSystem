...
//                "http://localhost:8080/Server_war_exploded/skiers/%d/seasons/%s/days/%s/skiers/%d",
//                resortID, seasonID, dayID, skierID));

//        HttpPost postRequest = new HttpPost(String.format(
//                "http://BlancerForA2-735442252.us-west-2.elb.amazonaws.com:80/Server-2.0-SNAPSHOT/skiers/%d/seasons/%s/days/%s/skiers/%d",
//                resortID, seasonID, dayID, skierID));

        HttpPost postRequest = new HttpPost(String.format(
                "http://50.112.254.22:8080/Server-2.0-SNAPSHOT/skiers/%d/seasons/%s/days/%s/skiers/%d",
                resortID, seasonID, dayID, skierID));
